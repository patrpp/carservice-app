  ...
  if (user) {
    return (
      <main className="flex min-h-screen flex-col items-center justify-center gap-8">
        <p className="text-2xl">Sikeres bejelentkezés!</p>
        <p className="text-xl">Email: {user.email}</p>
        <button
          onClick={signOut}
          className="px-6 py-3 bg-red-600 text-black rounded-lg"
        >
          Kijelentkezés
        </button>
        <Link
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center gap-8">
      ...
      <button
        ...
        className="px-8 py-4 bg-gray-600 text-white rounded-lg text-xl flex items-center gap-3"
      >
